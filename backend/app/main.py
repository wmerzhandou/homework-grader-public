...
if FRONTEND_DIST.is_dir():
    # 缓存策略：assets 是带哈希文件名的静态资源（一年不变），index.html 必须每次协商
    # ——否则改了前端，手机浏览器会一直拿旧 index.html 指向旧 bundle，看起来"没更新"。
    @app.middleware("http")
    async def frontend_cache_headers(request, call_next):  # noqa: ANN001
