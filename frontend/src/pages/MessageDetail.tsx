        ...
        {summary && (
          <section className="rounded-3xl border-l-4 border-emerald-400 bg-emerald-50/60 p-5 print:shadow-none">
            ...
            <div className="markdown-body text-base leading-relaxed">
              <ReactMarkdown components={{ a: MarkdownLink }}>{summary}</ReactMarkdown>
            </div>
          </section>
        )}
        ...
        {isEnglishPassage ? (
          ...
          <section className="rounded-3xl bg-white p-5 shadow-sm sm:p-8 print:shadow-none">
            ...
            <div className="markdown-body text-lg leading-loose">
              {detail ? (
                <ReactMarkdown components={{ a: MarkdownLink }}>{detail}</ReactMarkdown>
              ) : (
                <ReactMarkdown components={{ a: MarkdownLink }}>{message.text}</ReactMarkdown>
              )}
            </div>
          </section>
        )}
